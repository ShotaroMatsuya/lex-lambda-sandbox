...
def build_options(slot, appointment_type, date, booking_map):
    ...
    if slot == "AppointmentType":
        ...
        availabilities = get_availabilities_for_duration(
            get_duration(appointment_type), availabilities
        )
...
def make_appointment(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        validation_result = validate_book_appointment(
        ...
        if appointment_type and date:
            ...
            appointment_type_availabilities = get_availabilities_for_duration(
                get_duration(appointment_type), booking_availabilities
            )
            ...
            if appointment_time:
                output_session_attributes["formattedTime"] = build_time_output_string(
                    appointment_time
                )
                    ...
                    slots,
                    {
                        ...
                        "content": "{}{} is our only availability, does that work for you?".format(
                            ...
                            build_time_output_string(
                                appointment_type_availabilities[0]
                            ),
                        ),
                    },
                    build_response_card(
            ...
            available_time_string = build_available_time_string(
